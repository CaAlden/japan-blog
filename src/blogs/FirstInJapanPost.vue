<template>
  <BlogPostBase
    ...
    <div class="col-12 blog-body">
      <p>I am finally in Japan! This is the first of many blog posts where I will attempt to
    ...
    <div class="col-6 blog-body">
      <p>I landed in Japan on the 3rd of July at around 8:30 PM and was through customs by 9.
    ...
    <ImageCard layout="col-6" src="assets/blog1/map.png">
      Map of Stations
    </ImageCard>
    <div class="clear"></div>
    <div class="col-12 blog-body">
      <p>If you’ve never been to Tokyo, there are more train lines than I think anyone could possibly
    ...
    <div class="clear"></div>
    <ImageCard layout="col-6" src="assets/blog1/inkan.jpg">
      My Inkan, used in place of a signature
    </ImageCard>
    <div class="col-6 blog-body">
      <p>Eventually a local train did arrive, and I was able to make it to the Motohasunuma Station a
    ...
    <div class="col-12 blog-body">
      <p>Kim landed on the 10th at Haneda airport. Haneda is much closer to the actual city,
         ...
         It was not all bad though, this lead to our first experience with Japanese Taxis.</p>
    </div>
    <div class="clear"></div>
    <ImageCard layout="col-6" src="assets/blog1/tokyo.jpg">
      Tokyo Downtown (PC: Kimberly Whitney)
    </ImageCard>
    <div class="col-6 blog-body">
    ...
    <div class="clear"></div>
    <div class="col-12 blog-body">
        <p>The next day we visited my soon-to-be office building and Kim was able to see the impressive
    ...
    <div class="clear"></div>
    <div class="col-6">
      <ImageCard src="assets/blog1/shibuya.jpg">
        Shibuya's famous intersection
      </ImageCard>
    </div>
    <div class="col-6">
      <ImageCard src="assets/blog1/office_view.jpg">
    ...
    <ImageCard layout="col-3" src="assets/blog1/claws.jpg">
      Claws the stuffed Shibe-inu (PC: Kimberly Whitney)
    </ImageCard>
    <div class="clear"></div>
    <ImageCard layout="col-6" src="assets/blog1/meiji.jpg">
      A gate at Meiji Jingu (PC: Kimberly Whitney)
    </ImageCard>
    <div class="col-6 blog-body">
      <p>The next day we visited Meiji-Jingu, a famous Shinto shrine near Harajuku, where we bought Omamori
    ...
    <div class="clear"></div>
    <div class="col-6">
      <ImageCard src="assets/blog1/octopus.jpg">
        Octopus Skewers at the open air market. (PC: Kimberly Whitney)
      </ImageCard>
    </div>
    <div class="col-6">
      <ImageCard src="assets/blog1/shrine_path.jpg">
        Lanterns at the Yasaka Shrine in Kyoto (PC: Kimberly Whitney)
      </ImageCard>
    </div>
    <div class="clear"></div>
    <div class="col-3 video-box">
      <video width="100%" height="auto" controls>
        <source src="@/assets/blog1/fire_drink.mp4" type="video/mp4">
        Uh oh! You're browser doesn't support videos!
      </video>
    </div>
    <div class="blog-body col-9">
    ...
    <div class="clear"></div>
    <div class="col-4">
      <ImageCard src="assets/blog1/okonomiyaki.jpg">
        Okonomiyaki at the mother-daughter shop (PC: Kimberly Whitney)
      </ImageCard>
    </div>
    <div class="col-4">
      <ImageCard src="assets/blog1/fushimi_inari_posts.jpg">
        Gates lining the path to the summit of Mount Inari (PC: Kimberly Whitney)
      </ImageCard>
    </div>
    <div class="col-4">
    ...
    <div class="blog-post col-12">
      <p>In the morning we set out for Mount Fuji which was a hell of a travel day. You would expect getting there to be
    ...
    <div class="clear"></div>
    <div class="col-4">
      <ImageCard src="assets/blog1/gyu_kaku.jpg">
        Cooking up some Japanese BBQ at Gyu-Kaku (PC: Kimberly Whitney)
      </ImageCard>
    </div>
    <div class="col-4">
      <ImageCard src="assets/blog1/kim_fuji.jpg">
        Kim looks across the lake at Mount Fuji behind the clouds
      </ImageCard>
    </div>
    <div class="col-4">
      <ImageCard src="assets/blog1/fuji_bike.jpg">
        Biking around the lake at the base of Mount Fuji (PC: Kimberly Whitney)
      </ImageCard>
    </div>
    <div class="clear"></div>
    <div class="col-9">
      <p>On Kim’s last night in Japan we visited a pizzeria called Savoy in Roppongi. Savoy is a hole in the wall pizza
    ...
    <ImageCard layout="col-3" src="assets/blog1/savoy.jpg">
      Pizza at Savoy in Roppongi (PC: Kimberly Whitney)
    </ImageCard>
  </BlogPostBase>
</template>
